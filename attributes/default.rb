...
default['pure-ftpd']['package'] = 'pure-ftpd'
case node['platform_family']
when 'debian'
  if %w(ldap mysql postgresql).include? node['pure-ftpd']['backend']
    default['pure-ftpd']['package'] = "pure-ftpd-#{node['pure-ftpd']['backend']}"
  end
end
